...
program_version_link="https://proxy.yaoyaoling.net/https://raw.githubusercontent.com/clangcn/onekey-install-shell/master/frps/version.sh"
str_install_shell=https://proxy.yaoyaoling.net/https://raw.githubusercontent.com/clangcn/onekey-install-shell/master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
